    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
            <a href="/#" className="flex justify-center ">
                    <img src={props.dark ? Darklogo : logo} alt="logo" classNameName='w-40 h-12 md:w-96 md:h-24' />
            </a>
                <ul className="text-lg  flex items-center justify-center flex-col gap-4 md:flex-row md:gap-12 transition-all duration-500 py-12 mb-8 border-b border-[#ee5e2c]">
                    <li><a href="#" className="text-black hover:text-[#ee5e2c]  dark:hover:text-[#ee5e2c]   dark:text-white">Home</a></li>
                    <li><a href="#" className=" text-black hover:text-[#ee5e2c] dark:hover:text-[#ee5e2c]  dark:text-white">About</a></li>
                    <li><a href="#" className=" text-black hover:text-[#ee5e2c] dark:hover:text-[#ee5e2c]  dark:text-white">Benifits DM</a></li>
                    <li><a href="#" className=" text-black hover:text-[#ee5e2c] dark:hover:text-[#ee5e2c]  dark:text-white">Clients</a></li>
                    <li><a href="#" className=" text-black hover:text-[#ee5e2c] dark:hover:text-[#ee5e2c]  dark:text-white">Blog</a></li>
                    <li><a href="#" className=" text-black hover:text-[#ee5e2c] dark:hover:text-[#ee5e2c]  dark:text-white">Feedback</a></li>
                    <li><a href="#" className=" text-black hover:text-[#ee5e2c] dark:hover:text-[#ee5e2c]  dark:text-white">Contact Us</a></li>
                </ul>
